  ...
  return (
    <div className="w-full text-center">
      ...
      <div
        id={panelId}
        className={cn(
          "mx-auto mt-3 w-full grid min-h-0 transition-[grid-template-rows] duration-50 ease-out motion-reduce:transition-none",
      ...
      >
        <div className="min-h-0">
          <div
            className={cn(
              "will-change-transform transform-gpu transition-opacity transition-transform duration-50 ease-out motion-reduce:transition-none",
